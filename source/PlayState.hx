...
class PlayState extends MusicBeatState
{
	...
	// Rolling Again variables
	public var seen = false;
	public var allowCountdown = true;
	...
	override public function create()
	{
		...
		if(ClientPrefs.optimizationType != EXTREME){
			switch (SONG.song.toLowerCase())
			{
				case 'rolling':
					...
					var greenBg:FlxSprite = new FlxSprite(-400, -200);
					greenBg.loadGraphic(Paths.image('miku/green'), false, FlxG.width, FlxG.height);
					greenBg.alpha = 0;
					add(greenBg);
					...
					overlay.loadGraphic(Paths.image('miku/overlay'), false, 0, 0);
		...
		switch (curStage)
		{
			case 'rolling':
				...
				opponentCameraOffset = [275, 105];
				girlfriendCameraOffset = [480, 365];
		}
